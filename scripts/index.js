...
// FOR CREATING CARD ON THE HOME PAGE 
...
//  FOR CREATING Dynamic  MODALS CARDS ON OUR HOME PAGE/UI
...
// UPDATING OUR LOCAL STORAGE OF THE MODALS WHICH ARE DISPLAYED ON OUR UI
...
//HERE TO GET DATA OR CARD OR MODAL ON UR UI FORM LOCAL STORAGE
...
const handleSubmit = (event) => {
  ...
  // updated task list FOR 1ST 
  state.taskList.push({ ...input, id });

  // UPDATE THE SAME IN LOACAL STORAGE TOO 2ND
  updateLocalStorage();
};

// OPEN NEW MODALS
const openTask = (e) => {
  // REMOVE THE CURRENT ONE MODAL
  if (!e) e = window.event;

  // FIND THE CARD OPENED
